...
export const Button = ({
    ...
    switch (variant) {
        case "accent": //Default
            variantStyles = "bg-primary hover:bg-primary-300 text-white rounded";
            break;
        case "secondary": 
            variantStyles = "bg-primary-200 hover:bg-primary-300/40 text-primary rounded";
            break;
        case "outline": 
        ...
        case "ico": 
            if (iconTheme === "accent"){
                variantStyles = "bg-primary hover:bg-primary-300 text-white rounded-full"
            }
            if (iconTheme === "secondary"){
                variantStyles = "bg-primary-200 hover:bg-primary-300/40 text-primary rounded-full";
            }
            if (iconTheme === "gray"){
